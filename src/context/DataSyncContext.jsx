...
const formatUserCardProgressForSupabase = (progress) => ({
  ...
  const updateCourse = async (id, updates) => {
   const updatedCourse = { ...updates, updated_at: new Date().toISOString(), isSynced: false };
  ...
  const value = {
    ...
    handleDeleteCardsOfSubject, handleReassignCardsOfSubject, reviewCard, addCourse, updateCourse,
