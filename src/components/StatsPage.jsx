...
const StatsPage = () => {
  ...
  const stats = useMemo(() => {
    ...
    // Calcul de la maîtrise moyenne basée sur ease_factor
    ...
    // Convertir ease_factor (min: 1.3, max: ~3.0) en pourcentage
  ...
  const difficultCards = useMemo(() => {
    if (!cards) return [];
    return [...cards]
      .filter(c => (c.reviewCount || 0) > 3 && c.easeFactor && c.easeFactor < 2.0)
  ...
  return (
    <div className="main-content">
      ...
      <div className="dashboard-grid">
        ...
        <div className="glass-card">
          <h3 style={{ fontSize: '1.125rem', fontWeight: 600, color: 'var(--text-heading-color)', marginBottom: '1rem' }}>
            Maîtrise par matière
          </h3>
        ...
        <div className="glass-card">
          ...
          {difficultCards.length > 0 ? (
                ...
                >
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                      {subjectMap.get(card.subject_id) || 'N/A'} • {card.reviewCount || 0} révisions
                    </p>
                  </div>
                  <span style={{ 
                    fontSize: '0.875rem', 
                    fontWeight: 600, 
                    color: 'var(--stat-value-review)',
                    marginLeft: '1rem',
                    flexShrink: 0
                  }}>
                    {Math.round((card.easeFactor || 0) * 100)}%
                  </span>
                </div>
              ))}
            </div>
            ...
            <div style={{ 
              ...
              Aucune carte difficile détectée<br/>Continuez vos révisions !
            </div>
          )}
        </div>
