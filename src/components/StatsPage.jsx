...
const StatsPage = () => {
  ...
  const streakData = useMemo(() => {
    // TODO: Implémenter le tracking réel des révisions quotidiennes
    // Pour l'instant, on retourne un tableau vide ou des données basées sur l'historique réel
    if (!cards) return [];
    
    // On peut compter les révisions par jour basées sur updated_at
    ...
    // Cette logique devrait être améliorée avec un vrai tracking
    return last30Days;
  }, [cards]);
