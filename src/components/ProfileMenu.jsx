          ...
          {isOpen && (
            ...
            >
              ...
              <div className="px-4 py-3 border-b border-border">
                <p className="text-sm font-medium text-text-heading-color truncate">
                  {session?.user?.email}
                </p>
              ...
              <div className="py-2">
                <button
                  ...
                  className="w-full px-4 py-2.5 text-left text-sm flex items-center gap-3 hover:bg-muted-bg transition-colors text-text-color"
                >
                  <Settings size={16} />
